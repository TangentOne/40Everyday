...
def filtered_accumulate(merger, start, cond, n, term):
    ...
    9
    >>> filtered_accumulate(mul, -3, greater_than_5, 5, square)  # -3 * 9 * 16 * 25
    -10800
...
def funception(func_a, start):
    ...
    4
    >>> func_b4 = funception(func_a, 3)
    >>> func_b4(3)    # Returns func_a(3) since start >= stop
    4
    >>> func_b5 = funception(func_a, -2)
    >>> func_b5(-3)    # Returns None since start < 0
    >>> func_b6 = funception(func_a, -1)
    >>> func_b6(4)    # Returns None since start < 0
    """
    "*** YOUR CODE HERE ***"
    res = func_a(start)
    def func_b(stop):
...
func_b5 = funception(func_a, -2)
print(func_b5(-3))    # Returns None since start < 0
func_b1 = funception(func_a, 0)
print(func_b1(3))  # func_a(0) * func_a(1) * func_a(2) = 1 * 2 * 3 = 6
func_b3 = funception(func_a, 3)
print(func_b3(6))
func_b2 = funception(func_a, 3)
print(func_b2(4))
